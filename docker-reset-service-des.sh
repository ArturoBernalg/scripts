...
do
    curl -X POST "http://ic.sanitas.dom/jenkins/view/self-service/job/self-service-docker-reset-service-des/buildWithParameters?serviceName="$service --user $jnkUser:$jnkPassword
